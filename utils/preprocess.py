...
# from https://github.com/tsinghua-rll/VoxelNet-tensorflow
...
def process_pointcloud(point_cloud, cls=cfg.TARGET_OBJ):
	# Input:
	#   (N, 4)
	# Output:
	#   voxel_dict
...
def worker(filelist):
	for file in filelist:
		...
		output_dir = 'voxel' if cfg.TARGET_OBJ == 'Car' else 'voxel_ped'
